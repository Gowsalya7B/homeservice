...
{
    public partial class loginpay4 : System.Web.UI.Page
    {
        ...
        protected void login_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select *  from bookform4 where Name='" + usertxt.Text + "'and New_Password='" + passtxt.Text + "'", conn);
