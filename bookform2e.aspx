<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookform2e.aspx.cs" Inherits="HomeServiceProvider.bookform2e" %>
...
<body bgcolor="#99ccff">
    ...
    <h3 align="center" 
        ...
        Font-Bold="True" onclick="Button1_Click" Text="Submit" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" BackColor="#FFCC66" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Black" NavigateUrl="~/Electriciang.aspx" Height="20px">X   Cancel</asp:HyperLink>
    &nbsp;
