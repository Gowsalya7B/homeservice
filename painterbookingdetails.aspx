<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="painterbookingdetails.aspx.cs" Inherits="HomeServiceProvider.painterbookingdetails" %>
...
<body>
    ...
    <br />
    <br />
    <h1 style="color: #FFFFFF; text-align: center;">Booking Details Of Painter Works</h1>
    <br />
    <br />
    <br />
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        GridLines="None" Height="16px" style="margin-left: 98px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:gowsiConnectionString27 %>" 
        ProviderName="<%$ ConnectionStrings:gowsiConnectionString27.ProviderName %>" 
        SelectCommand="select *from bookform2"></asp:SqlDataSource>
    <br />
    </form>
</body>
</html>
