<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookform.aspx.cs" Inherits="HomeServiceProvider.bookform" %>
...
<body bgcolor="#99ccff">
    ...
    <h3 align="center" 
        ...
        <asp:Button ID="submitbtn" runat="server" BackColor="#FFCC66" Text="Submit" 
        Width="119px" Font-Bold="True" onclick="submitbtn_Click" />

        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink 
        ID="HyperLink1" runat="server" BackColor="#FFCC66" Font-Bold="True" 
        Font-Names="Times New Roman" ForeColor="Black" NavigateUrl="~/Plumberg.aspx">X   Cancel</asp:HyperLink>
    &nbsp;
