<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Painterg.aspx.cs" Inherits="HomeServiceProvider.Painterg" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Painter Works</title>
<style type="text/css">
        #form1
        {
            height: 788px;
...
<body style="background-color: #FFCCFF">
    ...
    <h2 style="color: #3399FF; text-align: center;">Painting Works</h2>
                ...
                <tr><td class="style8">
                    ...
                    <td class="style8">
                        <asp:Label ID="Label1" runat="server" Font-Bold="False" 
                            ...
                            Font-Size="Large" ForeColor="#00CC99">Whitewash</asp:Label>
                    </td>
                    ...
                    <td class="style8">
                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="Large" 
                            ...
                            PostBackUrl="~/bookformpn1.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style8">
                    ...
                    <td class="style8">
                        <asp:Label ID="Label2" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Distemper Coating</asp:Label>
                    </td>
                    <td class="style8">
                        <asp:LinkButton ID="LinkButton2" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn2.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style10">
                    ...
                    <td class="style10">
                        <asp:Label ID="Label3" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Waterproof Painting</asp:Label>
                    </td>
                    <td class="style10">
                        <asp:LinkButton ID="LinkButton3" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn3.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style9">
                    ...
                    <td class="style9">
                        <asp:Label ID="Label4" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Wood Painting</asp:Label>
                    </td>
                    <td class="style9">
                        <asp:LinkButton ID="LinkButton4" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn4.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td>
                    ...
                    <td class="style6">
                        <asp:Label ID="Label5" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Wall Art</asp:Label>
                    </td>
                    <td class="style6">
                        <asp:LinkButton ID="LinkButton5" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn5.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td>
                    ...
                    <td class="style7">
                        <asp:Label ID="Label6" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Door And Furniture Painting</asp:Label>
                    </td>
                    <td class="style7">
                        <asp:LinkButton ID="LinkButton6" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn6.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style8">
                    ...
                    <td class="style8">
                        <asp:Label ID="Label7" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Creative Decorations Using Paints</asp:Label>
                    </td>
                    <td class="style8">
                        <asp:LinkButton ID="LinkButton7" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn7.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style12">
                    ...
                    <td class="style12">
                        <asp:Label ID="Label8" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Building Painting</asp:Label>
                    </td>
                    <td class="style12">
                        <asp:LinkButton ID="LinkButton8" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn8.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style12">
                    ...
                    <td class="style12">
                        <asp:Label ID="Label9" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Ceiling Art</asp:Label>
                    </td>
                    <td class="style12">
                        <asp:LinkButton ID="LinkButton9" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn9.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                 <td class="style11">
                    ...
                    <td class="style11">
                        <asp:Label ID="Label10" runat="server" Font-Names="Rockwell" 
                            Font-Size="Large" ForeColor="#00CC99">Boundary Wall Painting</asp:Label>
                    </td>
                    <td class="style11">
                        <asp:LinkButton ID="LinkButton10" runat="server" Font-Size="Large" 
                            Font-Strikeout="False" Font-Underline="True" style="text-align: right" 
                            PostBackUrl="~/bookformpn10.aspx">Click Here!</asp:LinkButton>
                    </td>
                </tr>
            </table>
        
     </div>
    <div style="float:right; width:409px; height:310px; background-image: url('hspimages/SAVE_20191229_194806.jpg'); margin-left: 1px;"></div>
    </form>
</body>
</html>
