...
{
    public partial class bookformc10 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            serviceidtxt.Text = Session["s19"].ToString();
            servicetxt.Text = Session["s20"].ToString();
        }
        ...
        protected void submitbtn_Click(object sender, EventArgs e)
        {
            ...
            string mysql = "insert into bookform3 values('" + a + "','" + servicetxt.Text + "','" + nametxt.Text + "','" + b + "','" + emailidtxt.Text + "','" + addresstxt.Text + "','" + datetxt.Text + "','" + newpasstxt.Text + "','" + conpasstxt.Text + "')";
