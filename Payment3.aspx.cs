...
namespace HomeServiceProvider
{
    public partial class Payment3 : System.Web.UI.Page
    {
        ...
        protected void paybtn_Click(object sender, EventArgs e)
        {
            ...
            string mysql = "insert into carpenterservice values('" + a + "','" + b + "','" + c + "','" + d + "','" + partsnamelbl.Text + "','" + f + "','" + g + "','" + servicetxt.Text + "','" + h + "','" + i + "')";
        ...
        protected void sfindbtn_Click(object sender, EventArgs e)
        {
            ...
            string mysql = "Select *from carpentservice where Service_Id=" + serviceidtxt.Text;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                servicetxt.Text = ds.Tables[0].Rows[0]["Service"].ToString();
