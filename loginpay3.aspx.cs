...
{
    public partial class loginpay3 : System.Web.UI.Page
    {
        ...
        protected void login_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select *  from bookform3 where Name='" + usertxt.Text + "'and New_Password='" + passtxt.Text + "'", conn);
