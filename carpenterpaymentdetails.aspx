<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carpenterpaymentdetails.aspx.cs" Inherits="HomeServiceProvider.carpenterpaymentdetails" %>
...
<body>
    ...
    <br />
    <br />
    <h2 style="text-align: center; background-color: #33CCCC; width: 1027px;">Carpenter Payment Details</h2><br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataSourceID="SqlDataSource1" style="margin-left: 91px" Width="196px" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:gowsiConnectionString31 %>" 
        ProviderName="<%$ ConnectionStrings:gowsiConnectionString31.ProviderName %>" 
        SelectCommand="select *from carpenterservice"></asp:SqlDataSource>
