<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginforpay.aspx.cs" Inherits="HomeServiceProvider.loginforpay" %>
...
<br/>
    ...
    <div class="loginbox">
        <h2 style="color: #0099CC; text-align: center; width: 322px;"> LogIn For Payment</h2>
        </div>
    ...
    <img src="hspimages/App-login-manager-icon.png" alt="Alternate Text" class="user" /><br />
        ...
        <br />
        <br />
        <asp:Button Text="Log In" runat="server" ID="signbtn" 
            ForeColor="#0033CC" Width="304px" onclick="signbtn_Click"  />
        <br />
        <br />
