<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookformE10.aspx.cs" Inherits="HomeServiceProvider.bookformE10" %>
...
<body bgcolor="#99ccff">
    ...
    <h3 align="center" 
        ...
        <asp:Button ID="submitbtn" runat="server" BackColor="#FF9933" Text="Submit" 
        onclick="submitbtn_Click" />

        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink 
        ID="HyperLink1" runat="server" BackColor="#FFCC66" Font-Bold="True" 
        Font-Names="Times New Roman" ForeColor="Black" 
        NavigateUrl="~/Electriciang.aspx">X   Cancel</asp:HyperLink>
    &nbsp;
