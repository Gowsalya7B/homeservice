<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carpenterbookingdetails.aspx.cs" Inherits="HomeServiceProvider.carpenterbookingdetails" %>
...
<body>
    ...
    <br />
    <br />
    <h1 style="color: #FFFFFF; text-align: center;">Booking Details Of Carpenter Works</h1>
    <br />
    <br />
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:gowsiConnectionString24 %>" 
        
        ProviderName="<%$ ConnectionStrings:gowsiConnectionString24.ProviderName %>" SelectCommand="select *from bookform3
"></asp:SqlDataSource>
</form>
