<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="electricianbookingdetails.aspx.cs" Inherits="HomeServiceProvider.electricianbookingdetails" %>
...
<body>
    ...
    <br />
    <br />
    <h1 style="color: #FFFFFF; text-align: center;">Booking Details Of Electrician Works</h1>
    <br />
    <br />
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:gowsiConnectionString26 %>" 
        
        
        ProviderName="<%$ ConnectionStrings:gowsiConnectionString26.ProviderName %>" SelectCommand="select *from bookform2
"></asp:SqlDataSource>
    </form>
</body>
</html>
