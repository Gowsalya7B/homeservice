<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pl_Pipe.aspx.cs" Inherits="HomeServiceProvider.pl_Pipe" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" 
            ForeColor="#FF66CC" NavigateUrl="~/plumber.aspx">&lt;-Back To Plumbing Works</asp:HyperLink>
        <br />
        &nbsp;<br />
       
    <asp:DataList ID="DataList1" runat="server" CellPadding="4" 
        DataSourceID="SqlDataSource1" ForeColor="#006699" RepeatColumns="2" 
        RepeatDirection="Horizontal" Width="487px" 
        BorderColor="#9900FF" BorderStyle="None" BorderWidth="1px" Height="593px" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:gowsiConnectionString16 %>" 
        ProviderName="<%$ ConnectionStrings:gowsiConnectionString16.ProviderName %>" 
        SelectCommand="select *from plumber_pipe"></asp:SqlDataSource>
    </form>
