...
namespace HomeServiceProvider
{
    public partial class Payment2 : System.Web.UI.Page
    {
        ...
        protected void servicefindbtn_Click(object sender, EventArgs e)
        {
            ...
            string mysql = "Select *from electricservice where Service_Id=" + serviceidtxt.Text;
        ...
        protected void partsfindbtn_Click(object sender, EventArgs e)
        {
            MySqlConnection conn;
            conn = new MySqlConnection("server=localhost;user id=root;password=gowsibaby7;database=gowsi;");
            string mysql = "Select *from electricianparts where Parts_Id=" + partsidtxt.Text;
            MySqlCommand cmd = new MySqlCommand(mysql, conn);
            MySqlDataAdapter da = new MySqlDataAdapter();
            da.SelectCommand = cmd;
            DataSet ds = new DataSet();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                partsidtxt.Text = ds.Tables[0].Rows[0]["Parts_Id"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            int d = Convert.ToInt16(partsidtxt.Text);
            ...
            string mysql = "insert into electricianservice values('" + a + "','" + b + "','" + c + "','" + d + "','" + partsnametxt.Text + "','" + f + "','" + g + "','" + servicetxt.Text + "','" + h + "','" + i + "')";
